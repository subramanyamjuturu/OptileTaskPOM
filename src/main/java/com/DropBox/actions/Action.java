...
public class Action 
{
	...
	public void enterText(String Objectproperties,String Text,WebDriver driver,String ResultPath,String TestDescription) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
	...
	public void enterPassword(String Objectproperties,String Text,WebDriver driver,String ResultPath,String TestDescription) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
	...
	//This method is for entering text to any web applications 
	public void selectValue(String Objectproperties,String DropDownOption,String Text,WebDriver driver,String ResultPath,String TestDescription) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
...
//		ObjectProprtyValue=ObjectPropertiesArray[1];
	...
	public void VerifyText(String Objectproperties,String Text,WebDriver driver,String ResultPath,String TestDescription) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
	...
	public void Select(String Objectproperties,String Text,WebDriver driver,String ResultPath,String TestDescription) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
	...
	public void ClearTex(String Objectproperties,WebDriver driver) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
		...
		try
		{
			...
			if(ObjectProprty.equalsIgnoreCase("Name"))
			{
				//selenium code for waiting until element is displayed
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.name(ObjectProprtyValue)));
				//selenium code for clearing
				driver.findElement(By.name(ObjectProprtyValue)).clear();
			}
			else if(ObjectProprty.equalsIgnoreCase("Id"))
			{
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(ObjectProprtyValue)));
				driver.findElement(By.id(ObjectProprtyValue)).clear();

			}
			else if(ObjectProprty.equalsIgnoreCase("Xpath"))
			{
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(ObjectProprtyValue)));
				driver.findElement(By.xpath(ObjectProprtyValue)).clear();

			}
			else if(ObjectProprty.equalsIgnoreCase("Class"))
			{
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.className(ObjectProprtyValue)));
				driver.findElement(By.className(ObjectProprtyValue)).clear();
	...
	public void Click(String Objectproperties,String Text,WebDriver driver,String ResultPath,String TestDescription) throws Exception
	{
		ObjectPropertiesArray = Objectproperties.split("@@@");
		ObjectProprty=ObjectPropertiesArray[0];
		ObjectProprtyValue=ObjectPropertiesArray[1];
